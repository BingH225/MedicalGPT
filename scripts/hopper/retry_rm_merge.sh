...
RM_JOB_ID="$1"
RUN_DIR="${OUTPUT_ROOT}/rm_${RM_JOB_ID}"
ADAPTER_DIR="${RUN_DIR}/adapter"
SFT_MERGED_DIR="${ARTIFACT_ROOT}/merged/sft-qwen35-2b"
MERGED_DIR="${ARTIFACT_ROOT}/merged/rm-qwen35-2b"
...
python -u tools/merge_peft_adapter.py \
  --base_model '${SFT_MERGED_DIR}' \
  --tokenizer_path '${SFT_MERGED_DIR}' \
